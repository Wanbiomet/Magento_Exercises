...
class Interceptor extends \Magenest\Movie\Controller\Adminhtml\Movie\Save implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Backend\App\Action\Context $context, \Magenest\Movie\Model\ResourceModel\Movie $movieResourceModel, \Magenest\Movie\Model\MovieFactory $movieFactory, \Magento\Framework\Controller\Result\RedirectFactory $resultRedirectFactory, \Magento\Framework\App\RequestInterface $request)
    {
        $this->___init();
        parent::__construct($context, $movieResourceModel, $movieFactory, $resultRedirectFactory, $request);
    }
