...
class Interceptor extends \Magento\Shipping\Block\Adminhtml\Order\Packaging implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getShipment()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getShipment', func_get_args(), $pluginInfo) : parent::getShipment();
    }
    ...
    public function getConfigDataJson()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getConfigDataJson', func_get_args(), $pluginInfo) : parent::getConfigDataJson();
    }
    ...
    public function getContainerTypeByCode($code)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getContainerTypeByCode', func_get_args(), $pluginInfo) : parent::getContainerTypeByCode($code);
    }
    ...
    public function getDeliveryConfirmationTypeByCode($code)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getDeliveryConfirmationTypeByCode', func_get_args(), $pluginInfo) : parent::getDeliveryConfirmationTypeByCode($code);
    }
    ...
    public function getContentTypeByCode($code)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getContentTypeByCode', func_get_args(), $pluginInfo) : parent::getContentTypeByCode($code);
    }
    ...
    public function getPackages()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getPackages', func_get_args(), $pluginInfo) : parent::getPackages();
    }
    ...
    public function getShipmentItem($itemId, $itemsOf)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getShipmentItem', func_get_args(), $pluginInfo) : parent::getShipmentItem($itemId, $itemsOf);
    }
    ...
    public function displayCustomsValue()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('displayCustomsValue', func_get_args(), $pluginInfo) : parent::displayCustomsValue();
    }
    ...
    public function getDeliveryConfirmationTypes()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getDeliveryConfirmationTypes', func_get_args(), $pluginInfo) : parent::getDeliveryConfirmationTypes();
    }
    ...
    public function getPrintButton()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getPrintButton', func_get_args(), $pluginInfo) : parent::getPrintButton();
    }
    ...
    public function isGirthAllowed()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('isGirthAllowed', func_get_args(), $pluginInfo) : parent::isGirthAllowed();
    }
    ...
    public function getCustomValueCurrencyCode()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getCustomValueCurrencyCode', func_get_args(), $pluginInfo) : parent::getCustomValueCurrencyCode();
    }
    ...
    public function displayPrice($price)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('displayPrice', func_get_args(), $pluginInfo) : parent::displayPrice($price);
    }
    ...
    public function displayCustomsPrice($price)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('displayCustomsPrice', func_get_args(), $pluginInfo) : parent::displayCustomsPrice($price);
    }
    ...
    public function getQtyOrderedItem($itemId)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getQtyOrderedItem', func_get_args(), $pluginInfo) : parent::getQtyOrderedItem($itemId);
    }
    ...
    public function getSourceSizeModel()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getSourceSizeModel', func_get_args(), $pluginInfo) : parent::getSourceSizeModel();
    }
