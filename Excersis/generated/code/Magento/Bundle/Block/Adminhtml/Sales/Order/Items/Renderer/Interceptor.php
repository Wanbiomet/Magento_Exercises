...
class Interceptor extends \Magento\Bundle\Block\Adminhtml\Sales\Order\Items\Renderer implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getChildren($item)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getChildren', func_get_args(), $pluginInfo) : parent::getChildren($item);
    }
    ...
    public function getOrderItem()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getOrderItem', func_get_args(), $pluginInfo) : parent::getOrderItem();
    }
